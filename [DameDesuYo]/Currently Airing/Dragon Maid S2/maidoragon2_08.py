...
# Common variables
# OP/ED frames
opstart: Union[int, bool] = 744
edstart: Union[int, bool] = 31408
op_offset: int = 3
ed_offset: int = 3

hardsub_sign: List[Range] = [  # Leftover hardsubbed signs that need a stronger mask
    (0, 41), (489, 530), (4582, 4683), (5395, 5477), (5891, 5902), (7237, 7515), (7586, 7645),
    (7692, 7883), (7944, 8135), (8473, 8919), (9460, 9631), (9726, 9766), (11954, 12073),
    (12192, 12323), (12382, 12443), (14295, 14366), (14449, 14473), (14738, 14766), (15522, 15820),
    (21578, 21625), (22156, 22191), (24026, 24060), (31281, 31407), (33598, 33642), (33845, 34044)
]
