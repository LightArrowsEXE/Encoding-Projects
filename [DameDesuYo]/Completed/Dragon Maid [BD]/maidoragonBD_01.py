...
# Sources
JP_BD = vse.FileInfo(f"{ini.bdmv_dir}/[BDMV] Kobayashi-san Chi no Maid Dragon Vol.1/BDMV/STREAM/00000.m2ts", (None, -36))  # noqa
...
def filterchain() -> Union[vs.VideoNode, Tuple[vs.VideoNode, ...]]:
    ...
    pre_dpir = lvf.deblock.vsdpir(src, strength=25, mode='deblock', matrix=1)
