...
# Sources
JP_BD = FileInfo(r'BDMV/[BDMV][220119][PCXE-51005][小林さんちのメイドラゴンS][Vol.S Fin]/MAIDRAGON_S_S/BDMV/STREAM/00000.m2ts',
                 (None, -30), idx=lambda x: source(x, force_lsmas=True, cachedir=''), preset=[PresetBD, PresetFLAC])
