...
# Sources
JP_BD = vse.FileInfo(f"{ini.bdmv_dir}/[BDMV][Keijo!!!!!!!!][Vol.3]/BDMV/STREAM/00014.m2ts", (None, -24))
...
if __name__ == '__main__':
    vse.EncodeRunner(JP_BD, FILTERED).video('x265', '.settings/x265_settings', zones=zones) \
        .audio('flac').mux('LightArrowsEXE@DameDesuYo') \
        .patch([(1037, 1060), (2113, None)], external_file="premux/KeijoBD_NCOP1v1 (Premux).mkv")
