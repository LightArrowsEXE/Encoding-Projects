...
# Sources
JP_BD = FileInfo(f"{config['bdmv_dir']}/[BDMV][Keijo!!!!!!!!][Vol.1]/BDMV/STREAM/00006.m2ts",  # noqa
                 (None, -24), idx=lambda x: source(x, force_lsmas=True, cachedir=''), preset=[PresetBD])
...
if __name__ == '__main__':
    ...
    enc.Encoder(JP_BD, FILTERED).run(zones=zones, flac=True)
