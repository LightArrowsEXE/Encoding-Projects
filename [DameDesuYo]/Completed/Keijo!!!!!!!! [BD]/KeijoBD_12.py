...
# Sources
JP_BD = vse.FileInfo(f"{ini.bdmv_dir}/[BDMV][Keijo!!!!!!!!][Vol.6]/BDMV/STREAM/00001.m2ts", (None, -27))
JP_NCOP = vse.FileInfo(f"{ini.bdmv_dir}/[BDMV][Keijo!!!!!!!!][Vol.5]/BDMV/STREAM/00006.m2ts", (24, -24))
...
no_filter_ranges: List[Range] = [  # Ranges that should not be filtered
    (31030, 31215)
]
...
def filterchain(src: vs.VideoNode = JP_BD.clip_cut,
    ...
    no_filter = lvf.rfs(deband, src, no_filter_ranges)

    merge_creds = core.std.MergeDiff(depth(no_filter, 32), diff)
