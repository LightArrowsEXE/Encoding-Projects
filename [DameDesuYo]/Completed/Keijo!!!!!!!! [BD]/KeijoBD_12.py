...
# Sources
JP_BD = FileInfo(f"{config['bdmv_dir']}/[BDMV][Keijo!!!!!!!!][Vol.6]/BDMV/STREAM/00001.m2ts", (None, -27),
                 idx=lambda x: source(x, force_lsmas=True, cachedir=''), preset=[PresetBD])
JP_NCOP = FileInfo(f"{config['bdmv_dir']}/[BDMV][Keijo!!!!!!!!][Vol.5]/BDMV/STREAM/00006.m2ts", (24, -24),
