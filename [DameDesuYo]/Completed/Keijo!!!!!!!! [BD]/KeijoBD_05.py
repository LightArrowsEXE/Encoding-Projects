...
# Sources
JP_BD = FileInfo(f"{config['bdmv_dir']}/[BDMV][Keijo!!!!!!!!][Vol.3]/BDMV/STREAM/00000.m2ts", (None, None),
                 idx=lambda x: source(x, force_lsmas=True, cachedir=''), preset=[PresetBD])
JP_NCOP = FileInfo(f"{config['bdmv_dir']}/[BDMV][Keijo!!!!!!!!][Vol.1]/BDMV/STREAM/00006.m2ts", (None, -24),
