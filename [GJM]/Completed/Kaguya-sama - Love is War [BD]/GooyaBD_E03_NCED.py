...
# Sources
JP_BD = FileInfo(f"{config['bdmv_dir']}/かぐや様は告らせたい Vol.2/BD/BDMV/STREAM/00009.m2ts", (None, -24),
...
def filterchain(src: vs.VideoNode = JP_BD.clip_cut) -> Union[vs.VideoNode, Tuple[vs.VideoNode, ...]]:
    ...
    merge_creds = core.std.MaskedMerge(depth(deband, 32), cshift, credit_mask)
