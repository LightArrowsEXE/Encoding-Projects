...
# Sources
JP_BD = FileInfo(f"{config['bdmv_dir']}/かぐや様は告らせたい Vol.2/BD/BDMV/STREAM/00001.m2ts", (None, -25),
...
JP_NCED = FileInfo(f"{config['bdmv_dir']}/かぐや様は告らせたい Vol.2/BD/BDMV/STREAM/00009.m2ts", (None, -24),
                   idx=lambda x: source(x, force_lsmas=True, cachedir=''))
