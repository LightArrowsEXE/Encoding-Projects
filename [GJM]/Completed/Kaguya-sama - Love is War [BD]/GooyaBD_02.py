...
# Sources
JP_BD = FileInfo(f"{config['bdmv_dir']}/かぐや様は告らせたい Vol.1/BD/BDMV/STREAM/00002.m2ts", (None, -26),
...
def filterchain(src: vs.VideoNode = JP_BD.clip_cut,
    ...
    BACKEND = Backend.TRT(fp16=True) if run_script else Backend.ORT_CUDA(fp16=False)
