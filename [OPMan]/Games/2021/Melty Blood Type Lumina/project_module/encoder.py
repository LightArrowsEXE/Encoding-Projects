...
from vardautomation import (JAPANESE, Chapter, ChapterStream, FFV1Encoder,
...
class Encoder:
    ...
    def run(self, clean_up: bool = True, make_comp: bool = True,
        ...
        audio_tracks = None  # wmv is a dumb format.
        ...
        muxer = Mux(
            self.file,
            streams=(
                VideoStream(self.file.name_clip_output, 'HEVC GameRip by LightArrowsEXE@Kaleido', JAPANESE),
