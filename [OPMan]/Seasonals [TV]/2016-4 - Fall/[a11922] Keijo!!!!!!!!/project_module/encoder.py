...
class Encoder:
    ...
    def run(self, clean_up: bool = True, lossless: bool = False, make_comp: bool = False,
            x264: bool = False, prefetch: Optional[int] = None, flac: bool = False, all_tracks: bool = False,
            zones: Optional[Dict[Tuple[int, int], Dict[str, Any]]] = None,
            qp_clip: Optional[vs.VideoNode] = None, audio_clip: Optional[FileInfo] = None,
            resumable: bool = True, settings: Optional[str] = None) -> None:
        """
        ...
        audio_files = video_source(
            in_file=self.file.path.to_str() if not audio_clip else audio_clip.path.to_str(),
