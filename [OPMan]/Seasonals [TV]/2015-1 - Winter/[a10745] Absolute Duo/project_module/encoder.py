...
class Encoder:
    ...
    def run(self, prep_out: bool = True, clean_up: bool = True, lossless: bool = False, make_comp: bool = False,
        ...
        """
        :param prep_out:    Perform limited range clamping and 10bit dithering on output clip
...
class Patcher:
    ...
    def patch(self, x264: bool = False, ranges: int | Tuple[int, int] | List[int | Tuple[int, int]] = [],
              clean_up: bool = True, external_file: os.PathLike[str] | str | None = None) -> None:
        """
        ...
        """
        logger.info(f'Patching using {"x264" if x264 else "x265"}.')
