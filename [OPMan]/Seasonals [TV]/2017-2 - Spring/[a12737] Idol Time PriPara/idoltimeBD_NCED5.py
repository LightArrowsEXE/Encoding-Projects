...
# Sources
JP_BD = FileInfo(r"E:/src/Idol Time PriPara/IDOL_TIME_PRIPARA_BDBOX4_D2/BDMV/STREAM/00026.m2ts", (24, -24),
...
spline36_ranges: List[Range] = [  # Scenes that were upscaled using Spline36 rather than Sharp Cubic
    (547, 734), (854, 1140), (1468, 1592), (1693, 1811), (1942, None)
]
...
def filterchain() -> Union[vs.VideoNode, Tuple[vs.VideoNode, ...]]:
    ...
    clmp = lvf.rfs(clmp, sraa_strong, [(223, 269)])
