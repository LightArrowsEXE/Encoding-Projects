...
# Sources
JP_BD = FileInfo(r"BDMV/Deadman Wonderland/EXTRAS/OP (Director's Cut Version).mkv", (12, -36),
                 idx=lambda x: source(x, force_lsmas=True, cachedir=''), preset=[PresetBD, PresetFLAC])
JP_NCOP = FileInfo(r"BDMV/Deadman Wonderland/EXTRAS/OP (TV Cut Version).mkv", (12, -36),
