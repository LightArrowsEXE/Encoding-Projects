...
# Sources
JP_BD = FileInfo(r'BDMV/DISC7/BDMV/STREAM/00008.m2ts', (24, -24),
...
def filterchain() -> Union[vs.VideoNode, Tuple[vs.VideoNode, ...]]:
    ...
    denoise_uv_wk = ccd(denoise_y_wk, threshold=4, matrix='709')

    denoise_y_str = core.knlm.KNLMeansCL(scaled, d=2, a=3, h=0.4)
    denoise_uv_str = ccd(denoise_y_str, threshold=25, matrix='709')
    denoise_uv = lvf.rfs(denoise_uv_wk, denoise_uv_str, [(None, 266)])

    denoise_no = lvf.rfs(denoise_uv, scaled, [(1027, 1056), (1260, 1314)])

    stab = haf.GSMC(denoise_no, radius=1, thSAD=200, planes=[0])
