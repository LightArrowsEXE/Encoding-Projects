...
# Sources
JP_BD = FileInfo(r'BDMV/[BDMV][210728][Yuru Camp Season 2][Vol.3 Fin]/BD/BDMV/STREAM/00008.m2ts', [(24, -24)],
...
opstart = 1356
edstart = False
op_start_offset = 8  # This episode specifically cuts into the first few frames... fml dude
op_offset = 7
ed_offset = 1
...
def filterchain() -> Union[vs.VideoNode, Tuple[vs.VideoNode, ...]]:
    ...
    if opstart is not False:
        op_scomp = lvf.scomp(src[opstart:opstart+src_ncop.num_frames-1]+b, src_ncop[op_start_offset:-op_offset]+b) \
    ...
    if opstart is not False:
        src = insert_clip(src, src_ncop[op_start_offset:-op_offset], opstart)
        src = lvf.rfs(src, src_c, [(opstart+803, opstart+851)])
    if edstart is not False:
