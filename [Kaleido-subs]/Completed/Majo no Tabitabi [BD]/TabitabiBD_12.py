...
# Sources
JP_BD = FileInfo(r'BDMV/[BDMV][210224][Majo no Tabitabi][Blu-Ray BOX下巻]/BDMV/STREAM/00012.m2ts',
...
CHAP_NAMES: Sequence[Optional[str]] = ['Intro', 'Part A', 'Part B', 'Outro', 'Epilogue']
