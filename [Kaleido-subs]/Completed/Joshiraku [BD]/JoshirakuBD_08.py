...
# Sources
JP_BD = FileInfo(r'BDMV/130123_JOSHIRAKU_VOL4/BDMV/STREAM/00000.m2ts', (34813, -45),
...
# Chapter handling
CHAPTERS = MplsReader(r"BDMV/130123_JOSHIRAKU_VOL4", lang=JAPANESE).get_playlist()[0].mpls_chapters[0].to_chapters()
