...
# Sources
JP_BD = FileInfo(r'BDMV/130522_JOSHIRAKU_VOL6/BDMV/STREAM/00000.m2ts', (69605, -29),
...
def filterchain() -> Union[vs.VideoNode, Tuple[vs.VideoNode, ...]]:
    ...
    # Fixing the ED having a special version for this episode
    src_trim = src[31888:]
    spliced_NCED = lvf.rfs(src_NCED, src_trim, [(2073, None)])
    ...
    ed_mask = vdf.dcm(
        src, src[edstart:edstart+src_NCED.num_frames-ed_offset], spliced_NCED[:-ed_offset],
