...
# Sources
JP_BD = FileInfo(r'BDMV/130227_JOSHIRAKU_VOL5/BDMV/STREAM/00000.m2ts', (24, 34790),
...
# Chapter handling
CHAPTERS = MplsReader(r"BDMV/130227_JOSHIRAKU_VOL5", lang=JAPANESE).get_playlist()[0].mpls_chapters[0].to_chapters()
