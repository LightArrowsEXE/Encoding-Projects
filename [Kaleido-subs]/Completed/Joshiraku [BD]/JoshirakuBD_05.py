...
# Sources
JP_BD = FileInfo(r'BDMV/121128_JOSHIRAKU_VOL3/BDMV/STREAM/00000.m2ts', (24, 34790),
...
# Chapter handling
CHAPTERS = MplsReader(r"BDMV/121128_JOSHIRAKU_VOL3", lang=JAPANESE).get_playlist()[0].mpls_chapters[0].to_chapters()
...
if __name__ == '__main__':
    ...
    enc.Encoder(JP_BD, FILTERED, CHAPTERS, CHAP_NAMES).run(clean_up=False)  # type: ignore
