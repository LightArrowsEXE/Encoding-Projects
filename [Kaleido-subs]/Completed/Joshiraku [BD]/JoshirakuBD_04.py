...
# Sources
JP_BD = FileInfo(r'BDMV/121024_JOSHIRAKU_VOL2/BDMV/STREAM/00000.m2ts', (34813, -46),
...
# Chapter handling
CHAPTERS = MplsReader(r"BDMV/121024_JOSHIRAKU_VOL2", lang=JAPANESE).get_playlist()[0].mpls_chapters[0].to_chapters()
