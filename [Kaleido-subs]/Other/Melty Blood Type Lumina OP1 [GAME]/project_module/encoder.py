...
class Encoder:
    ...
    def run(self, clean_up: bool = True, make_comp: bool = True,
        ...
        muxer = Mux(
            self.file,
            streams=(
                VideoStream(self.file.name_clip_output, 'HEVC Switch GameRip by LightArrowsEXE@Kaleido', JAPANESE),
                AudioStream(self.file.a_src_cut.format(0), 'FLAC 2.0', JAPANESE), None
            )
        )
