...
# Sources
JP_BD = FileInfo(r'BDMV/[BDMV][アニメ][210127][MAJO_NO_TABITABI_1][Blu-Ray BOX 上]/BDMV/STREAM/00003.m2ts',
...
def pre_corrections() -> Union[vs.VideoNode, Tuple[vs.VideoNode, ...]]:
    ...
    sqmask = lvf.mask.BoundingBox((1084, 663), (225, 200)).get_mask(src_BD).bilateral.Gaussian(sigma=10)
    fixed = lvf.rfs(src_BD, src_BD.std.MaskedMerge(src_WEB, sqmask), [(1226, 1227)])
    ...
    fixed = lvf.rfs(fixed, fixed.std.MaskedMerge(src_WEB, sqmask), [(3330, 3365)])
