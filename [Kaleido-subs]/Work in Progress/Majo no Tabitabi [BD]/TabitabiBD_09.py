...
# Sources
JP_BD = FileInfo(r'BDMV/[BDMV][210224][Majo no Tabitabi][Blu-Ray BOX下巻]/BDMV/STREAM/00005.m2ts',
...
CHAP_NAMES: Sequence[Optional[str]] = ['Intro', 'Part A', 'Part B', 'ED']
...
def filterchain() -> Union[vs.VideoNode, Tuple[vs.VideoNode, ...]]:
    ...
    grain = lvf.rfs(grain, rkt, [(31877, None)])  # No point in adding grain to pure black/white stuff
