...
for f in *.vpy; do
    ...
    --preset veryslow --crf 14.5 --deblock=-2:-2 --keyint 240 --min-keyint 23 --ref 6 --bframes 16 \
    --aq-mode 3 --aq-strength 0.95 --qcomp 0.70 --cbqpoffs -2 --crqpoffs -2 --rc-lookahead 60 \
    --rd 3 --rdoq-level 2 --psy-rd 2.0 --psy-rdoq 2.0 --cutree \
    ...
    time mkvmerge -o "premux/$(basename $f .vpy) (Premux).mkv" -v "$(basename $f .vpy).265" "$(basename $f _down.vpy)_cut.m4a";
done
