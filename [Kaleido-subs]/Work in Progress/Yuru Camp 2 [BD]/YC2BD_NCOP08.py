...
JP_EP = FileInfo(r'BDMV/[BDMV][210728][Yuru Camp Season 2][Vol.3 Fin]/BD/BDMV/STREAM/00004.m2ts',
                 [(1514+24, 1514+2184)], idx=lambda x: source(x, force_lsmas=True, cachedir=''))
