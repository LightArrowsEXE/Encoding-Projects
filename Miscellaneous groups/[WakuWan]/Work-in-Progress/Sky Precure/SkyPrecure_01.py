...
def filterchain(clip: vs.VideoNode, draft: bool = False) -> vs.VideoNode | tuple[vs.VideoNode, ...]:
    ...
    # Ep2 fixed the credits cutting out early at the end. Fixing here.
    ep2 = lvf.src("src/[SubsPlease] Hirogaru Sky! Precure - 02 (1080p) [E9CB476D].mkv")[252:]
    clip = insert_clip(clip, ep2[4773:4775], 5059)
...
if __name__ == "__main__":
    ...
    runner.audio(
        external_audio_clip=A_SRC.clip, external_audio_file=A_SRC.path,
