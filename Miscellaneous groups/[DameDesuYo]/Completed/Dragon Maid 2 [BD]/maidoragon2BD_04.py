...
# Sources
JP_BD = FileInfo(r'BDMV/[BDMV][211020][PCXE-51002][小林さんちのメイドラゴンS][Vol.2]/MAIDRAGON_S_2/BDMV/STREAM/00000.m2ts',
                 (None, -32), idx=lambda x: source(x, force_lsmas=True, cachedir=''), preset=[PresetBD, PresetFLAC])
