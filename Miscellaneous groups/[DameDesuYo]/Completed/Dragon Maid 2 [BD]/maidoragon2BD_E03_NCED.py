...
# Sources
JP_BD = FileInfo(r'BDMV/[BDMV][211225][PCXE-51004][小林さんちのメイドラゴンS][Vol.4]/MAIDRAGON_S_4/BDMV/STREAM/00006.m2ts',
                 (None, -24), idx=lambda x: source(x, cachedir=''), preset=[PresetBD, PresetFLAC])
...
def filterchain() -> Union[vs.VideoNode, Tuple[vs.VideoNode, ...]]:
    ...
    if opstart is not False:
        ...
        grain = core.std.MaskedMerge(grain, depth(ncop_ef, 32), sqmask)
