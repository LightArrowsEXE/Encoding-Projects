...
# Sources
JP_BD = FileInfo(r'BDMV/[BDMV][210915][PCXE-51001][小林さんちのメイドラゴンS][Vol.1]/MAIDRAGON_S_1/BDMV/STREAM/00002.m2ts',
                 (None, -34), idx=lambda x: source(x, force_lsmas=True, cachedir=''), preset=[PresetBD, PresetFLAC])
...
JP_ED = FileInfo(r'BDMV/[BDMV][211225][PCXE-51004][小林さんちのメイドラゴンS][Vol.4]/MAIDRAGON_S_4/BDMV/STREAM/00006.m2ts',
                 (None, -24), idx=lambda x: source(x, force_lsmas=True, cachedir=''))
